...
def predict():
  ...
  response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/ca8edeb2-7378-4955-8441-32f845dd436f/predictions?version=2022-09-16', json=payload_scoring,
